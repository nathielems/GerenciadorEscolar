...
@section('content')
<form action="{{route('salvarProfessor')}}" method="post" class="form-horizontal" id="formProduto">
    @csrf
    <div class="card">
        <div class="card-header">
            <h4 class="col-12 modal-title text-center">Cadastrar Professor </h5>
        </div>
...
{!! JsValidator::formRequest('App\Http\Requests\ValidacaoProfessor'); !!}
